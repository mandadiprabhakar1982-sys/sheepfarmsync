...
export function MobileNav() {
  ...
  return (
    ...
    >
      <div className="h-20 bg-[#081122]/95 backdrop-blur-2xl border border-white/10 flex justify-around items-center rounded-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          ...
          {navItems.map((item, index) => {
            ...
            return (
              <Link 
                ...
                href={item.href}
                className={cn(
                  "flex flex-col items-center justify-center gap-1.5 transition-all active:scale-90 flex-1 h-full",
