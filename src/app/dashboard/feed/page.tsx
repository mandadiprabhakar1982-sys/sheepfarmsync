          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="px-3 py-0.5 bg-black/20 rounded-lg text-white flex items-center gap-2 border border-white/10">
                ...
                <div>
                  <p className="text-[6px] font-black uppercase tracking-widest opacity-40 leading-none">Net Fodder Cost</p>
                  <p className="text-base font-black tracking-tighter leading-none mt-0.5">₹{totalFeedCost.toLocaleString()}</p>
                </div>
              </div>
            </div>
          </div>
