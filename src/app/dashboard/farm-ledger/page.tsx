  ...
  return (
    <div className="container mx-auto py-8 animate-in fade-in duration-700 max-w-7xl">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        ...
        <select 
          className="h-14 px-6 rounded-2xl bg-white border-slate-100 shadow-sm font-bold text-slate-600 outline-none"
        ...
        <button 
          ...
          className="bg-[#0F766E] hover:bg-[#134E4A] text-white rounded-2xl px-10 h-14 text-sm font-black tracking-[0.18em] uppercase shadow-xl transition-all active:scale-95 flex items-center gap-3"
        >
