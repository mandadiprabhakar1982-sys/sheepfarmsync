...
export default function OverviewPage() {
  ...
  const MobileBreakdownCard = ({ title, value, icon: Icon, color, href }: { title: string, value: string, icon: any, color: string, href?: string }) => {
    const content = (
      <div className="bg-white rounded-2xl p-5 flex flex-col items-center text-center shadow-sm border border-slate-100 aspect-square justify-center active:scale-[0.98] transition-all">
    ...
    <div className="max-w-lg mx-auto space-y-8 py-4 animate-in fade-in duration-700 pb-24">
      ...
      <section>
        <div className="grid grid-cols-2 gap-4 px-2 mb-6">
          <div className="bg-emerald-600 rounded-[1.5rem] p-6 text-white shadow-lg">
          ...
          <div className="bg-rose-600 rounded-[1.5rem] p-6 text-white shadow-lg">
    ...
    <div className="space-y-12 animate-in fade-in duration-1000 pb-20 px-4 md:px-0">
      ...
      <section>
        ...
        <div className="flex gap-6">
          <Card className="flex-1 border-none shadow-xl rounded-[2.5rem] bg-white p-10 flex items-center gap-8 group hover:-translate-y-1 transition-all">
          ...
          <Card className="w-[300px] border-none shadow-xl rounded-[2.5rem] bg-white p-10 flex items-center gap-6 group hover:-translate-y-1 transition-all">
      ...
      <section>
        ...
        <div className="space-y-4">
          {[
            ...
            <Link key={i} href={row.href} className="bg-white rounded-2xl h-16 px-8 flex items-center justify-between shadow-sm border border-slate-100 transition-all hover:bg-slate-50 group">
        ...
        <div className="grid grid-cols-4 gap-6">
          {[
            ...
            <Link key={i} href={stat.href}>
              <Card className="border-none shadow-xl rounded-[2rem] bg-white p-8 group hover:-translate-y-1 transition-all text-center flex flex-col items-center h-full">
